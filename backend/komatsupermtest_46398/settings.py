"""
Django settings for komatsupermtest_46398 project.
...
ROOT_URLCONF = 'komatsupermtest_46398.urls'
...
WSGI_APPLICATION = 'komatsupermtest_46398.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "komatsupermtest_46398 API",
    "DESCRIPTION": "API documentation for komatsupermtest_46398 App",
    "VERSION": "v1",
}
